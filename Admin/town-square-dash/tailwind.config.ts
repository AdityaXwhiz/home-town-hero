...
export default {
  darkMode: ["class"], // make sure your app toggles a `class="dark"` on <html> or <body>
  content: [
    "./pages/**/*.{ts,tsx}",
    "./components/**/*.{ts,tsx}",
    "./app/**/*.{ts,tsx}",
    ...
    extend: {
      colors: {
        ...
        civic: {
          ...
          sidebar: "hsl(var(--civic-sidebar))",
          "sidebar-active": "hsl(var(--civic-sidebar-active))",
        },
        sidebar: {
          ...
          dark: {
            ...
            foreground: "#ffffff", // make all text white
            primary: "#2563eb",   // blue-600 for primary in dark
          }
        },
      },
      borderRadius: {
