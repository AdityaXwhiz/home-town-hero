...
const Sidebar = ({ activeTab, setActiveTab }: SidebarProps) => {
  ...
  return (
    <div className="w-64 bg-civic-sidebar dark:bg-gray-900 border-r border-sidebar-border dark:border-gray-700 h-full flex flex-col">
      {/* Header */}
      <div className="p-6 border-b border-sidebar-border dark:border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-civic-blue dark:text-white">CivicSync</h1>
            <p className="text-xs text-muted-foreground dark:text-gray-400">Admin Portal</p>
          </div>
        </div>
      </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isActive 
                        ...
                        : "text-sidebar-foreground dark:text-gray-200 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground dark:hover:bg-gray-800 dark:hover:text-white"
                    )}
                  >
